...
kr9.value = 0.001
kc9.value = 20
# These next few were originally symbolic expressions so we need to use
# set_sym_expr to change them.
kr13.set_sym_expr(1)
kf22.set_sym_expr(momp_transloc)
kf26.set_sym_expr(momp_transloc)
